...
<center><i>[공개 검토에 참여하는 유관부서와 검토 관점]</i></center>
{{< /imgproc >}}
...
- 이 전제는 외부 기여를 받는 순간 달라진다. 기여자의 저작권이 섞이면 회사도 그 부분에 대해서는 라이선스를 지켜야 하는 쪽이 된다. 이 장이 권하는 컨트리뷰터 사다리를 운영하려면 CLA로 저작권을 회사에 집중시킬지, DCO로 기여자 저작권을 그대로 둘지 공개 시점에 정해 두어야 한다. 두 방식의 차이와 기업이 검토할 항목은 이 장의 법무팀 검토 항목과 [오픈소스SW 기여 가이드 - 기업 편: 4. CLA / DCO에 주의하라](../contributing/#4-cla--dco에-주의하라) 에서 다룬다.
